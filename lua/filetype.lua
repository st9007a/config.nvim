...
vim.cmd('autocmd FileType query setlocal expandtab shiftwidth=2 softtabstop=2')
...
vim.cmd('autocmd FileType javascript,typescript,html,css,sass,scss setlocal expandtab shiftwidth=2 softtabstop=2')
